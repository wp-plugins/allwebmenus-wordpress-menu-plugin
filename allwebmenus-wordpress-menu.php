...
if (get_option("AWM_total_menus")=="") add_option("AWM_total_menus",5);
if (isset($_GET["AWM_total_menus"]) && is_numeric($_GET["AWM_total_menus"])) update_option('AWM_total_menus',$_GET["AWM_total_menus"]);
$awm_total_tabs = get_option("AWM_total_menus");
