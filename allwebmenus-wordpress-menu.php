...
<?php 
	for ($awm_t=0; $awm_t<$awm_total_tabs; $awm_t++) {
?>
			<div class='awm_tab_body' id='AWM_tab_body_<?=$awm_t;?>'>
				<div><input id="AWM_menu_active_<?=$awm_t;?>" name="AWM_menu_active_<?=$awm_t;?>" onclick="awm_uncheck(<?=$awm_t;?>);" type="checkbox" value="true" <?php if (get_option('AWM_menu_active_'.$awm_t)) echo "checked='checked'"; ?> /> <strong>Show "<?=get_option('AWM_menu_name_'.$awm_t);?>" in blog</strong>
				&nbsp;&nbsp;&nbsp;<?php if (!get_option('AWM_menu_active_'.$awm_t)) { ?><span id='AWM_unchecked_<?=$awm_t;?>' style='color:#990000;'>Unchecked! (this menu will not appear in your blog)</span><?php } else { ?><span id='AWM_unchecked_<?=$awm_t;?>' style='color:#009900;'>(this menu will appear in your blog)</span><?php } ?></div>
				<div style="padding-left: 19px; margin-top: 13px;"><strong>Menu name: </strong> <input name="AWM_menu_name_<?=$awm_t;?>" type="text" size="30" value="<?php echo get_option('AWM_menu_name_'.$awm_t) ?>"/></div>
				<div style="padding-left: 19px;" class="awm_itemInfo">Please make sure that the "Menu name" value matches the value in the "Compiled Menu Name" property of the AllWebMenus project file (<i>Tools > Project Properties > Folders</i>). <a href="javascript:void(0)" onclick="awm_folder_info('',<?=$awm_t;?>);">show me</a></div>
				<div id="AWM_folder_info_<?=$awm_t;?>" style="margin-top: 20px; display: none; background-color: #FEFCF5; border: #E6DB55 solid 1px;">
					<table>
						<tr><td style="width: 800px; text-align: center; padding-top: 10px; padding-bottom: 10px;"><strong>More info</strong> - <a href="javascript:void(0)" onclick="awm_folder_info('none',<?=$awm_t;?>);">close</a></td></tr>
						<tr><td style="width: 800px; text-align: center; padding-top: 0px; padding-bottom: 10px;">
						...
						<tr><td style="width: 800px; text-align: center; padding-top: 0px; padding-bottom: 10px;">
							<a href="javascript:void(0)" onclick="awm_folder_info('none',<?=$awm_t;?>);">close</a>
					</table>
				</div>
				<br>
				<fieldset class="options">
					...
					<table width="100%" height="auto" style="padding-left: 40px;">
						...
						<tr><td width="230"><input name="AWM_include_home_<?=$awm_t;?>" type="checkbox" value="true" <?php if (get_option('AWM_include_home_'.$awm_t)) echo "checked='checked'"; ?> /> <strong>"Home"</strong></td>
						<td class="awm_itemInfo">A "Home" item that opens the blog's Home Page.</td></tr>

						<tr><td colspan="2">&nbsp;</td></tr>
						<tr><td colspan="2">&nbsp;</td></tr>

						<tr><td width="230"><input name="AWM_pages_<?=$awm_t;?>" type="checkbox" <?php if (get_option('AWM_pages_'.$awm_t)) echo "checked='checked'"; ?> /> <strong>Pages:</strong></td>
						<td><span style="color: #009900">Show all Pages</span> <span style="color: #990000">except the following:</span></td></tr>
						<tr><td width="230">&nbsp;&nbsp;</td>
						<td><input name="AWM_excluded_pages_<?=$awm_t;?>" type="text" size="55" value="<?php echo get_option('AWM_excluded_pages_'.$awm_t) ?>"/></td></tr>
						...
						<tr><td colspan="2">&nbsp;</td></tr>
						<tr><td width="230">&nbsp;&nbsp;</td>
						<td><input name="AWM_pages_ms_<?=$awm_t;?>" value="main" type="radio" <?php if (get_option('AWM_pages_ms_'.$awm_t) == 'main') echo "checked='checked'"; ?> />&nbsp;Show Pages as Main Menu items</td></tr>
						<tr><td width="230">&nbsp;&nbsp;</td>
						<td><input name="AWM_pages_ms_<?=$awm_t;?>" value="sub" type="radio"<?php if (get_option('AWM_pages_ms_'.$awm_t) == 'sub') echo "checked='checked'"; ?> />&nbsp;Show a Main Menu item named <input name="AWM_pages_name_<?=$awm_t;?>" type="text" size="10" value="<?php echo get_option('AWM_pages_name_'.$awm_t) ?>"/>
						and show Pages as its submenu items</td></tr>
						
						<tr><td colspan="2">&nbsp;</td></tr>
						<tr><td colspan="2">&nbsp;</td></tr>
						
						<tr><td width="230"><input name="AWM_posts_<?=$awm_t;?>" type="checkbox" <?php if (get_option('AWM_posts_'.$awm_t)) echo "checked='checked'"; ?> /> <strong>Posts:</strong></td>
						<td><span style="color: #009900">Show the following Posts:</span></i></td></tr>
						<tr><td width="230">&nbsp;&nbsp;</td>
						<td><input name="AWM_posts_ids_<?=$awm_t;?>" type="text" size="55" value="<?php echo get_option('AWM_posts_ids_'.$awm_t) ?>"/></td></tr>
						<tr><td width="230" align="right">&nbsp;</td>
						<td class="awm_itemInfo">Post IDs, separated by commas. Example: 34, 59, 140</td></tr>
						<tr><td colspan="2">&nbsp;</td></tr>
						<tr><td width="230">&nbsp;&nbsp;</td>
						<td><input name="AWM_posts_ms_<?=$awm_t;?>" value="main" type="radio" <?php if (get_option('AWM_posts_ms_'.$awm_t) == 'main') echo "checked='checked'"; ?> />&nbsp;Show Posts as Main Menu items</td></tr>
						<tr><td width="230">&nbsp;&nbsp;</td>
						<td><input name="AWM_posts_ms_<?=$awm_t;?>" value="sub" type="radio"<?php if (get_option('AWM_posts_ms_'.$awm_t) == 'sub') echo "checked='checked'"; ?> />&nbsp;Show a Main Menu item named <input name="AWM_posts_name_<?=$awm_t;?>" type="text" size="10" value="<?php echo get_option('AWM_posts_name_'.$awm_t) ?>"/>
						and show Posts as its submenu items</td></tr>
						
						<tr><td colspan="2">&nbsp;</td></tr>
						<tr><td colspan="2">&nbsp;</td></tr>
						
						<tr><td width="230"><input name="AWM_categories_<?=$awm_t;?>" type="checkbox" <?php if (get_option('AWM_categories_'.$awm_t)) echo "checked='checked'"; ?> /> <strong>Categories:</strong></td>
						<td><span style="color: #009900">Show all Categories</span> <span style="color: #990000">except the following:</span></td></tr>
						<tr><td width="230">&nbsp;&nbsp;</td>
						<td><input name="AWM_excluded_cats_<?=$awm_t;?>" type="text" size="55" value="<?php echo get_option('AWM_excluded_cats_'.$awm_t) ?>"/></td></tr>
						<tr><td width="230" align="right">&nbsp;</td>
						...
						<tr><td width="230">&nbsp;&nbsp;</td>
						<td><input name="AWM_categories_subitems_<?=$awm_t;?>" type="checkbox" <?php if (get_option('AWM_categories_subitems_'.$awm_t)) echo "checked='checked'"; ?> /> Also show (up to) the <input name="AWM_categories_subitems_no_<?=$awm_t;?>" type="text" size="2" value="<?php echo get_option('AWM_categories_subitems_no_'.$awm_t) ?>"/> newest posts of each Category as its submenu items</td></tr>
						<tr><td width="230">&nbsp;&nbsp;</td>
						<td class="awm_itemInfo">Value must be between 1 and 50.</td></tr>
						<tr><td colspan="2">&nbsp;</td></tr>
						<tr><td width="230">&nbsp;&nbsp;</td>
						<td><input name="AWM_categories_ms_<?=$awm_t;?>" value="main" type="radio" <?php if (get_option('AWM_categories_ms_'.$awm_t) == 'main') echo "checked='checked'"; ?> />&nbsp;Show Categories as Main Menu items</td></tr>
						<tr><td width="230">&nbsp;&nbsp;</td>
						<td><input name="AWM_categories_ms_<?=$awm_t;?>" value="sub" type="radio" <?php if (get_option('AWM_categories_ms_'.$awm_t) == 'sub') echo "checked='checked'"; ?> />&nbsp;Show a Main Menu item named <input name="AWM_categories_name_<?=$awm_t;?>" type="text" size="10" value="<?php echo get_option('AWM_categories_name_'.$awm_t) ?>"/>
						...
						<tr><td width="230"><span style="margin-left: 20px;"><strong>Other:</strong></span></td><td>
							<input type="checkbox" name="AWM_hide_future_<?=$awm_t;?>" value="checkbox" <?php if (get_option('AWM_hide_future_'.$awm_t)) echo "checked='checked'"; ?>/> Hide future-dated posts
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="AWM_hide_protected_<?=$awm_t;?>" value="checkbox" <?php if (get_option('AWM_hide_protected_'.$awm_t)) echo "checked='checked'"; ?>/> Hide password-protected items
						</td></tr>
					...
					<input type="hidden" id="awm_initial_menu_type_<?=$awm_t;?>" value="<?=get_option('AWM_menu_type_'.$awm_t);?>"/>
					<table width="100%" height="auto" style="padding-left: 40px;">
						<tr><td colspan="2">&nbsp;</td></tr>
						<tr><td colspan="2" id="awm_changed_type_a_<?=$awm_t;?>" class="updated fade" style="display: none;">
						...
						<tr><td colspan="2" id="awm_changed_type_b_<?=$awm_t;?>">&nbsp;</td></tr>
						
						<tr><td width="230" valign="top"><table>
							<tr><td><span style="cursor: pointer;" onclick="awm_select_menu_type('Dynamic',<?=$awm_t;?>);"><strong><input id="AWM_menu_type_<?=$awm_t;?>_Dynamic" name="AWM_menu_type_<?=$awm_t;?>" value="Dynamic" type="radio" <?php if (get_option('AWM_menu_type_'.$awm_t) == 'Dynamic') echo "checked='checked'"; ?> />&nbsp;"Dynamic" Menu Type</strong></span></td></tr>
							<tr><td><span style="cursor: pointer;" onclick="awm_select_menu_type('Mixed',<?=$awm_t;?>);"><strong><input id="AWM_menu_type_<?=$awm_t;?>_Mixed" name="AWM_menu_type_<?=$awm_t;?>" value="Mixed" type="radio" <?php if (get_option('AWM_menu_type_'.$awm_t) == 'Mixed') echo "checked='checked'"; ?> />&nbsp;"Mixed" Menu Type</strong></span></td></tr>
							<tr><td><span style="cursor: pointer;" onclick="awm_select_menu_type('Static',<?=$awm_t;?>);"><strong><input id="AWM_menu_type_<?=$awm_t;?>_Static" name="AWM_menu_type_<?=$awm_t;?>" value="Static" type="radio" <?php if (get_option('AWM_menu_type_'.$awm_t) == 'Static') echo "checked='checked'"; ?> />&nbsp;"Static" Menu Type</strong></span></td></tr>
						</table></td><td valign="top">
							<div class="awm_itemInfo" id="AWM_menu_type_<?=$awm_t;?>_Dynamic_info" <?=get_option('AWM_menu_type_'.$awm_t)=='Dynamic'?'':'style="display:none;"'; ?>>
							...
							<div class="awm_itemInfo" id="AWM_menu_type_<?=$awm_t;?>_Mixed_info" <?=get_option('AWM_menu_type_'.$awm_t)=='Mixed'?'':'style="display:none;"'; ?>>
							...
							<div class="awm_itemInfo" id="AWM_menu_type_<?=$awm_t;?>_Static_info" <?=get_option('AWM_menu_type_'.$awm_t)=='Static'?'':'style="display:none;"'; ?>>
					...
					<table width="100%" height="auto" style="padding-left: 40px;">
						...
						<td valign="top"><input type="checkbox" name="AWM_Related_<?=$awm_t;?>" value="checkbox" <?php if (get_option('AWM_Related_'.$awm_t)) echo "checked='checked'"; if (!$awm_is_yarpp_enabled) echo "disabled='disabled'"; ?>/>
...
function AWM_generate_linking_code() {
	...
	for ($awm_t=0; $awm_t<$awm_total_tabs; $awm_t++) {
		...
		if ($awm_is_yarpp_enabled && get_option('AWM_Related_'.$awm_t) && is_single()) {
			...
			echo "IRP=$awm_parentgroup.newItem('style=mymenu_'+(wplevel==0?'main_item_style':'sub_item_style')+';visible=0');\n";
