...
*/
	...
	$plugin2_out .= '</textarea></p><div align="center"><p style="width:600px">Press <strong>Ctrl+C</strong> to copy the text and paste it into the <strong>Import Navigation Structure</strong> reader in the <strong>Wordpress Menu</strong> AllWebMenus plugin. (go to <strong>Add-ins > WordPress Menu > Import/Update Menu Structure from WordPress</strong>).</p></div>';
