...
Required software: AllWebMenus PRO (version 5.3.862 and above)
...
* Major Features
	* Full cross-browser support (Internet Explorer - including v9, all Mozilla based browsers (Firefox, etc), Opera, Safari, Google Chrome and many more)
...
As such, **AllWebMenus PRO** (v5.3.862 and above) is required to be installed in your machine.
