...
== Changelog ==
= 1.1.23 (requires AllWebMenus Build #926 or above) =
* Supports WordPress v4.2.2 (fixes some errors due to changes in WordPress)
= 1.1.22 (requires AllWebMenus Build #926 or above) =
* Supports different Site Address from the WordPress Address, plus different subfolders from the default ones.
