...
As such, **AllWebMenus PRO** (v5.3.884 and above) is required to be installed in your machine.
...
== Changelog ==
= 1.1.9 =
(requires AllWebMenus Build #884 or above)
...
= 1.1.6 =
(requires AllWebMenus Build #862 or above)
...
= 1.0.24 =
(requires AllWebMenus Build #818 or above)
...
= 1.0.12 =
(requires AllWebMenus Build #810 or above)
...
= 1.0.11 =
(requires AllWebMenus Build #804 or above)
...
= 1.0.10 =
(requires AllWebMenus Build #800 or above)
...
= 1.0.9 =
(requires AllWebMenus Build #772 or above)
...
= 1.0.4 =
(requires AllWebMenus Build #758 or above)
...
= 1.0.3 =
(requires AllWebMenus Build #756 or above)
* The GUI of the Add-in has been enhanced.
= 1.0.1 =
(requires AllWebMenus Build #754 or above)
* Initial release.
