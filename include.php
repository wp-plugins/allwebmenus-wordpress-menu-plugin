...
function awm_update_option_values() {
	...
	for ($awm_t=0; $awm_t<$awm_total_tabs; $awm_t++) {
		update_option('AWM_use_custom_menu_'.$awm_t, (bool) $_POST["AWM_use_custom_menu_".$awm_t]);
		update_option('AWM_use_custom_menu_id_'.$awm_t, (string) $_POST["AWM_use_custom_menu_id_".$awm_t]);
...
function awm_set_first_time_options() {
	...
	for ($awm_t=0; $awm_t<$awm_total_tabs; $awm_t++) {
		add_option('AWM_use_custom_menu_'.$awm_t, FALSE);
		add_option('AWM_use_custom_menu_id_'.$awm_t, '');
